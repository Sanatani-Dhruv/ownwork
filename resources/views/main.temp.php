...
<html lang="en">
	<head>
		...
		<title>{{ getenv("APP_NAME") }} App </title>
			<style>
				@includeRoot("/public/styles/tailwind.default.css")@
			</style>
		@endif;
	</head>
	<body style="" class="flex flex-col items-center justify-center pt-10 md:pt-15 bg-cyan-500/100 h-[75dvh]">
		...
		<p class="mt-8 hover:underline text-sm md:text-[1.2dvw]" style="">
			<a href="https://github.com/Sanatani-Dhruv/ownwork" target="__blank">
				<button class="transition border-3 font-semibold border border-black/100 p-3 pl-6 pr-6 cursor-pointer hover:rounded hover:bg-black/100 hover:text-white whitespace-nowrap">View Source</button>
			</a>
		</p>
	</body>
</html>
